      ...
      <TableCell align="right">
        <Tooltip title="View policy">
          <IconButton
            ...
            size="small"
            onClick={() => navigate(`/policy/${encodeURIComponent(parts[2])}`)}
          >
    ...
    <Box sx={{ py: 4 }}>
      ...
      <Container>
        ...
        <Typography variant="body1">
          Browse and manage all Policies in your Conjur instance.
        </Typography>
              ...
              >
                ...
                <TableBody>
                  {filteredResources.map((resource) => (
                    <PolicyItem key={resource.id} resource={resource} />
                  ))}
                </TableBody>
              </Table>
            </TableContainer>
