      ...
      <TableCell align="right">
        <Tooltip title="View secret">
          <IconButton
            ...
            size="small"
            onClick={() => navigate(`/secrets/${encodeURIComponent(parts[2])}`)}
          >
    ...
    <Box sx={{ py: 4 }}>
      ...
      <Container>
        ...
        <Typography variant="body1">
          Browse and manage all Secrets in your Conjur instance.
        </Typography>
        ...
        <Stack spacing={2} sx={{ mt: 3 }}>
          ...
          {loading && (
            <Stack direction="row" spacing={1} alignItems="center">
              ...
              <Typography variant="body2">Loading Secrets...</Typography>
            </Stack>
          )}
          ...
          {!loading && !error && resources.length === 0 && (
            <Alert severity="info">No Secrets returned by API.</Alert>
          )}
              ...
              >
                ...
                <TableBody>
                  {filteredResources.map((resource) => (
                    <SecretItem key={resource.id} resource={resource} />
                  ))}
                </TableBody>
              </Table>
            </TableContainer>
